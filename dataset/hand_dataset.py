    ...
    def _make_samples(self):
        ...
        for folder in os.listdir(self.root):
            for npy in os.listdir(os.path.join(self.root, folder, "hand")):
                npy_file = os.path.join(self.root, folder, "hand", npy)         #get numpy file
...
if __name__ == "__main__":
    dataset1 = HandDataset(r"C:\Users\wjg53\Desktop\Github\OpenPose-In-Opencv\data\hand", train=True)
    dataset2 = HandDataset(r"C:\Users\wjg53\Desktop\Github\OpenPose-In-Opencv\data\hand", train=False)
